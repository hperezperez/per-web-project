	...
	<div class="container">
		<div class="row">
			<div class="col-md-7">
				<div class="row">
					<div class="col-md-4">
						<img class="restaurant-image img-responsive" src="../images/pinata.jpg" alt="Product Image"/>
					</div>
					<div class="col-md-8">
						...
						<p class="product-description">
							Product description - Vendemos una amplia seleccion de pinatas. Precio regular 25.00 dolares I recommend we transfer power to phasers and arm the
							photon torpedoes. The weapons must have disrupted
